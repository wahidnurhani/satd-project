...
To classify the included example dataset cheeseDisease (in the data.examples directory), type the following at the command line while in the main classifier directory:

java -cp "*:." edu.stanford.nlp.classify.ColumnDataClassifier -prop data.examples/cheese2007.prop
