...
public class ClassifierDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ColumnDataClassifier cdc = new ColumnDataClassifier(where + "data/examples/iris2007.prop");
    cdc.trainClassifier(where + "data/examples/iris.train");
  ...
  private static void demonstrateSerialization()
    ...
    Classifier<String,String> cl =
            cdc.makeClassifier(cdc.readTrainingExamples(where + "data/examples/iris.train"));
    ...
    ois.close();
    ColumnDataClassifier cdc2 = new ColumnDataClassifier(where + "data/examples/iris2007.prop");

    // We compare the output of the deserialized classifier lc versus the original one cl
    // For both we use a ColumnDataClassifier to convert text lines to data.examples
    System.out.println();
